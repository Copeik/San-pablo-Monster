...
$OutputPath = Resolve-OutputPath $OutputPath "artifacts\plaza-farmacia-overview-v12.png"
$PlazaOutputPath = Resolve-OutputPath $PlazaOutputPath "artifacts\plaza-farmacia-plaza-v12.png"
$RuinOutputPath = Resolve-OutputPath $RuinOutputPath "artifacts\plaza-farmacia-ruina-v12.png"
...
function Draw-AnchoredSprite {
  ...
  $source = [System.Drawing.Bitmap]::FromFile((Resolve-RepoAsset $RelativePath))
  try {
    if ($FlipX) {
...
$base = [System.Drawing.Bitmap]::FromFile((Resolve-RepoAsset "maps\plaza-farmacia\base-v12.png"))
try {
  if ($base.Width -ne 1280 -or $base.Height -ne 1792) {
    throw "base-v12.png debe medir 1280x1792; mide $($base.Width)x$($base.Height)."
  }
  ...
  try {
    ...
    try {
      ...
      Draw-AnchoredSprite $graphics `
        "assets\generated\plaza-farmacia-pixellab\runtime-v12\buildings\plaza-u-continuous-v12.png" `
        640 800 1088 672

      Draw-AnchoredSprite $graphics `
        "assets\generated\plaza-farmacia-pixellab\runtime-v12\props\parking-lightwell-high.png" `
        640 540 192 192
      Draw-AnchoredSprite $graphics `
        "assets\generated\plaza-farmacia-pixellab\runtime-v12\props\parking-ramp-shared-320x160.png" `
        640 800 320 160

      Draw-AnchoredSprite $graphics `
        "assets\generated\plaza-farmacia-pixellab\runtime-v12\props\shop-chino-marker.png" `
        382 428 64 64
      Draw-AnchoredSprite $graphics `
        "assets\generated\plaza-farmacia-pixellab\runtime-v12\props\shop-seafood-marker.png" `
        382 748 64 64
      Draw-AnchoredSprite $graphics `
        "assets\generated\plaza-farmacia-pixellab\runtime-v12\props\shop-fruit-marker.png" `
        898 428 64 64

      $tablePlacements = @(
        @(450, 430), @(510, 430), @(450, 480), @(510, 480),
        @(770, 430), @(830, 430), @(770, 480), @(830, 480),
        @(450, 650), @(430, 720), @(850, 650), @(850, 720)
      )
      ...
      # El megacentro v12 integra su entrada; no hay sprite de entrada separado.
      Draw-AnchoredSprite $graphics `
        "assets\generated\plaza-farmacia-pixellab\runtime-v12\buildings\abandoned-megamall-v12.png" `
        640 1792 1152 512
...
Confirm-ImageDimensions $OutputPath 1280 1792 "Render v12"
Confirm-ImageDimensions $PlazaOutputPath 1280 1120 "Recorte plaza v12"
Confirm-ImageDimensions $RuinOutputPath 1280 704 "Recorte ruina v12"
